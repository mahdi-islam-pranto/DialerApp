...
class MediaRecorder implements RecorderBase {
  ...
  public void start(
    ...
    AudioFocusRequestCompat request = new AudioFocusRequestCompat.Builder(AudioManagerCompat.AUDIOFOCUS_GAIN_TRANSIENT_EXCLUSIVE)
            .setAudioAttributes(audioAttributes)
            .setOnAudioFocusChangeListener(new AudioManager.OnAudioFocusChangeListener() {
              @Override
              public void onAudioFocusChange(int focusChange) {

                System.out.println("onAudioFocusChange : "+focusChange );
              }
            }).build();

    switch (AudioManagerCompat.requestAudioFocus(audioManager, request)){

      case AudioManager.AUDIOFOCUS_REQUEST_GRANTED:
        System.out.println("[Audio Focus] Voice recording/playback audio focus request granted");
        break;

      case AudioManager.AUDIOFOCUS_REQUEST_FAILED:
        System.out.println("[Audio Focus] Voice recording/playback audio focus request failed");
        break;

      case AudioManager.AUDIOFOCUS_REQUEST_DELAYED:
        System.out.println("[Audio Focus] Voice recording/playback audio focus request delayed");
        break;
    ...
    recorder.setAudioSource(android.media.MediaRecorder.AudioSource.VOICE_COMMUNICATION);
